...
function writeSessionToken(session_token, data) {
	fs.writeFileSync('C:\\MarketKiller_Shared\\SessionConfig.json', data)
}

function writePurchase(data) {
    //fs.writeFileSync('C:\\MarketKiller_Shared\\PurchaseLog.txt', data);
    fs.appendFileSync('C:\\MarketKiller_Shared\\PurchaseLog.txt', time + "\n\n" + data);
}

function write_debug(data) {
    //fs.writeFileSync('C:\\MarketKiller_Shared\\PurchaseLog.txt', data);
    fs.appendFileSync('C:\\MarketKiller_Shared\\Debug.txt', "\n\n" + data);
}
